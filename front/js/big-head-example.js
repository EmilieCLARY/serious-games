...
function preload ()
{
    this.load.image('ground_1x1', '../img/big_head/tiles1.png');
    this.load.image('coin', '../img/big_head/melon.png', { frameWidth: 32, frameHeight: 32 });
...
function create ()
{
    ...
    groundLayer = map.createLayer('plat', groundTiles, 0, 0);
